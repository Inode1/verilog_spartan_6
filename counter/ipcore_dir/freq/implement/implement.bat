...
xst -ifn xst.scr
move freq_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\freq_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc freq_exdes.ucf freq_exdes

echo 'Running map'
map -timing -pr b freq_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm freq_exdes -w routed.ncd routed.v
cd ..
